...
export type Test = {
  __typename?: 'test';
  checkbox_test: Scalars['Boolean'];
  date_test: Scalars['date'];
  id: Scalars['uuid'];
  time_test: Scalars['time'];
  timestamp_test: Scalars['timestamp'];
  timestamptz_test: Scalars['timestamptz'];
  timetz_test: Scalars['timetz'];
};
